...
\begin{figure*}[htb]
  ...
  \includegraphics[width=\textwidth]{schematic-unfilled.pdf}
  \caption{
    \kc{You can remove whichever one you like less and leave comments about what I
    should fix in the diagram!}
  }
  \label{fig:schematic}
\end{figure*}
...
\begin{figure*}[htb]
  ...
  \apw{For the main case of vtravel=32, run for tune=4000, draws=40000 and remake}
  }
\end{figure*}
...
\begin{figure*}[htb]
  ...
  \apw{Can you remove the 99.7 line (so just 68 and 95), change the MLG range to
  (2.5, 7), change the eccentricity range to (0.5, 1), and set bins=101}
  \apw{try passing smooth=1 or something to smooth out the contours}
  }
\end{figure*}
