...
properties (\todo{ideas for citations?!}, \citep{Patel2017a,Dooley2017,Besla2018,Patel2018,Sawala2022}).
...
\todo{add note that we pulled the HST averaged PMs and did
 not use the full weighted pms from satellite kinematics.}
...
\begin{table*}
  ...
  ($\mu_\alpha^*$,  $\mu_\delta$)    & (45.15$\pm$12.66, -32.1$\pm$12.21) $\mu$as/yr (vdM12) & (48.98 $\pm$10.47, -36.85$\pm$8.03) $\mu$as/yr \citep{Salomon2021}\\
...
\begin{figure*}[htb]
  \centering
  \includegraphics[width=\textwidth,trim=1.3cm 0.8cm 1.3cm 0cm,clip=true]
