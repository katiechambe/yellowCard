...
it is unclear how this would affect the total mass. 
...
\todo{It is known that recent Gaia PMs of M31 suggest the orbit of MW--M31 is less radial than previously found.
Neglecting the travel velocity, we find that PMs from \textit{HST}~\citep{vdm2012} are consistent with a highly radial
orbit $e\sim0.96$, while PMs from \textit{Gaia}~\citep{Salomon2021} result in a slightly
lower eccentricity of $e\sim0.88$.
Inferred masses with the Timing Argument are highly sensitive to the
tangential motion of M31, and larger PMs will generically lead to higher
inferred LG masses. 

Additionally, a less radial orbit (higher tangential velocity) will result in higher masses.
  
However, we find that the eccentricity decreases with higher travel velocities ()

As the inferred mass decreases with an increase in the travel velocity, concurrent with a decrease in the eccentricity, the radial velocity contribution to the relative velocity of M31 is dominant
 However, , and thus, even though the eccentricity decreases with large travel velocity, the mass decreases as well. }

 inclusion of the travel velocity makes the local group more cosmologically typical (since we don’t really expect completely radial orbits from these systems) 
 Ferero romero and section 4 of vdm 2020 or something gaia dr2
 %%%%%%%%%%%
