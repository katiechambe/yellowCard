...
\begin{abstract}
    ...
    these techniques.
    \todo{I think we need a better concluding sentence!}
...
The mass of the Local Group is a fundamental quantity in many local
cosmological and MW applications.
The masses, spatial and kinematic
distribution, and merger history of galaxies in the Local Group are determined
by its total mass.
However, the existence of dark matter in the Local Group
makes the total mass challenging to measure.
...
\begin{table*}
  ...
  ($\mu_\alpha^*$,  $\mu_\delta$)    & (44.6$\pm$12.66, -32.1$\pm$12.21) $\mu$as/yr (vdMG08) & (48.98 $\pm$10.47, -36.85$\pm$8.03) $\mu$as/yr \citep{Salomon2021}\\
