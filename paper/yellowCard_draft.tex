...
from the Timing argument, is not straightforward, however the two approaches
are complimentary.
Future measurements of the travel velocity at large Galactocentric distances
will likely exceed current measurements (see Section~\ref{sec:vtrav}), which
directly implies a lower LG mass. 
...
limit of $~2.6\times10^{12}\Msun$ on the mass of M31.
...
larger PMs will generically lead to lower eccentricities and higher inferred LG
masses. 
Recent \gaia\ PMs of M31 suggest the orbit of MW--M31 is less radial than
previously believed~\citep{vdm2019,Salomon2021}.
Neglecting the travel velocity ($\vtrav=0$ in above plots), we find that PMs
from \textit{HST}~\citep{vdm2012} are consistent with a highly radial
orbit $e\sim0.96$, while PMs from \textit{Gaia}~\citep{Salomon2021} result in a
slightly lower eccentricity of $e\sim0.88$.
As seen in Fig.~\ref{fig:mvsv}, we find that as the travel velocity increases,
the inferred eccentricity of the MW--M31 orbit decreases. 
...
slightly less-than-radial orbit~\citep{vdm2019,Salomon2021}, we find that the
...
astropy:2018}.
as seen in Fig.~\ref{fig:mvsv})
\todo{KC and GB are supported by NSF CAREER AST-1941096 and NASA ATP 17-ATP17-0006.
}
\todo{APW }
\todo{EC}
\todo{NGC}
