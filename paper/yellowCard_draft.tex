...
% \subsection{}
% If we assume a MW mass of !10^12, 
...
dataset\raggedright{\footnote{Errors correspond to the 68\% credible regions about 
...
\begin{itemize}
  \item \textbf{The travel velocity of the MW disk directly implies a reduced
  ...
  halo. 
  In addition,  when using the vdm2012 hst PMs and vdm2008 dist., we find $\mlg =
  3.98\pm XX\times 10^{12}~\Msun$ which is XX lower than in vdm2012.
  %
  %
  \item \textbf{Including the travel velocity lowers the inferred eccentricity by blah amount.}
  This is true regardless of dataset, 
  Although eccentricity goes down, the inclusion of the travel velocity is dominant. 
  Recent Gaia PMs of M31 suggest the orbit of MW--M31 is less radial than previously found.
  PMs from \textit{HST}~\citep{vdm2012} are consistent with a highly radial
  orbit $e>0.9$ while PMs from \textit{Gaia}~\citep{Salomon2021} result in a
  lower eccentricity of $0.9>e>0.75$.
  ...
  %
  %
  \item \textbf{Improvements in M31 PM measurements will reduce our error estimates by a factor of two. }
  We naively divided our PMs errors by blah and found an improvement of blah
  %
  %
  \item \textbf{Higher travel velocity measurements will yield lower LG masses.}
  If travel velocities are measured to be higher at larger Galactocentric distances, the LG mass will be lower.
  Current travel velocity measurements go so far out in the halo (quote numbers) simulations (Nico and others? ) suggest that tracers at larger Galactocentric distances (distance range) will yield larger measurements of the travel velocity. This will result in a decrease in the LG mass by blah. Even larger values of the travel velocity result in an additional decrease
  in the inferred LG mass.
\end{itemize}
...
It is critical to refine our measurements of the PM of M31 and to measure the travel velocity of the MW disk with stellar tracers at further Galactocentric distances. Not only will these endeavors further refine our estimates of the mass of the LG to place it in a cosmological context, it will also continue to revolutionize our understanding of the galaxy dynamics at play in our LV. 
 
What does this mean for the MW and M31? It's important to get travel vel measurements at largest gal distances possible because that will set the lower bound of LG masses, which will start to place limits on the masses of the M31 and MW galaxy. 
