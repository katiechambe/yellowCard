...
This allows us to avoid modelling uncertainties in the LMC orbital 
...
We show that including the travel velocity of the MW disk lowers the
inferred Local Group mass from the Timing Argument when compared prior results
using the same compilation of M31 kinematic measurements, finding $\mlg =
3.98\times 10^{12}~\Msun$.
Using more recent distance and proper motion measurements of M31, we find a new,
completely empirical, measurement for the LG mass of 
$\mlg = 4.54\times10^{12}~\Msun$.
...
\begin{itemize}
  ...
  halo.
  Even larger values of the travel velocity result in an additional decrease
  in the inferred LG mass.
  %
  \item[-] \textbf{Recent M31 kinematic data suggests the orbit of MW--M31 
  is less radial than previously found.} 
  ...
  inferred LG masses.  
  %
  \item[-] \textbf{Improvements in M31 PM measurements will reduce our error 
...
distances. 
Not only will these endeavors further refine our estimates of the mass of the LG
to place it in a cosmological context, it will also continue to revolutionize 
our understanding of the galaxy dynamics at play in our LV.  
