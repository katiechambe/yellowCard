...
\begin{figure*}[htb]
  ...
  \apw{Change the eccentriity range to (0.5, 1)}
  \apw{Set bins=101 or some bigger number}
  \apw{try passing smooth=1 or something to smooth out the contours}
  \apw{Remove the shaded bands (Penarrubia and vdM2012) from the bottom left panel - they should only appaer in the histogram}
