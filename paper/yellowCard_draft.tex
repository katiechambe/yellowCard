...
studies \citep[e.g.,][]{stuff} \todo{TA refs}.
...
\begin{figure*}[htb]
  \centering
  \includegraphics[width=\textwidth]{schematic-filled.pdf}
  \caption{
    ...
    velocity of M31 from the Galactic center, respectively. \kc{should the
    velocity vec for M31 be M31$\to$\Msun?}
  }
  \label{fig:schematic}
\end{figure*}
