...
\kc{\begin{itemize}
  \item here, talk about how the assembly history of the MW and M31 has an impact on the dynamics of the pair. In the past, the impact of the LMC (and thus the change in MW+LMC barycenter) has been studied by Penarrubia et al. 
  \item Talk about how the LMC has pulled on the disk of the MW and about the predictions etc from that. (would solid body stuff have to go here?) Recent work by Benisty 
