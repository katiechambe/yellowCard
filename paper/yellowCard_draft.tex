...
We find that the ellipticity of the orbit decreases dramatically with larger travel velocities, however, in contradiction to \cite{Zhai2020}, we find that this leads to a lower total LG mass.
...
\begin{itemize}
  ...
  We scaled the proper motion errors in each dataset by ~6, the expected improvement in
