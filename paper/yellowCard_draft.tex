...
\begin{table*}
  ...
  \hline\hline
  \end{tabular}
  \tablerefs{$a.$ \cite{vdm2008}, $b.$ \cite{Courteau1999}, $c.$ \cite{vdm2012},\\
   $d.$ \cite{Schonrich2010,McMillan2011}, $e.$ \cite{Jarosik2011}, $f.$ \cite{Li2021},$g.$ \citep{Salomon2021},\\
  $h.$ \citep{Drimmel2018}, $i.$ \cite{Planck2018}}
