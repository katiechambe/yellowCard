...
are $\pos{\mwouter}{\odot}$ and $\vel{\mwouter}{\odot}$.
...
have been studied in detail by~\cite[e.g.,][]{Gomez2015,Garavito-Camargo:2019,
...
are given in Table~\ref{table:data} below). 
...
There have been two primary pathways to measure the mass of the LG in past years: measure the masses of MW and M31 individually and add them, or going after the total mass directly with LV dynamics, the Timing Argument, or cosmological simulations. 
...
There have been a few exceptions to the trend of high total mass measurements, 
...
find that the LMC likely has $~0.25\%$ of the mass of the MW halo, resulting in 
a large shift in the barycenter of the LMC+MW.
% Each of the Local Volume Galaxies is fit to a radial Keplerian orbital model.
% However, inclusion of any transverse motion will increase the inferred total
% mass of the system, so it is likely the assumption of radial orbits leads to
% an underestimate of the mass of the Local Group with LV galaxies only.
While the recovered mass using the dynamics of the LV galaxies was quite low  
($\sim 2\times 10^{12}\Msun$) compared to many Timing Argument-only studies, 
including the dynamics of the M31--MW system increased their recovered total 
...
We find we are roughly consistent with the previous Timing Argument model 
of~\cite{vdm2012}, who use the same values for the distance and velocity of 
M31 as in our \textit{vdMG08 Dist. + HST PM} dataset, and find a total mass 
of $4.27\pm0.45\times 10^{12}\Msun$ (neglecting for cosmic bias and 
scatter). 

and \cite{vdm2012,Zhai2020} and \cite{Benisty2022}
