...
simplifying the dynamics to a Keplerian orbital model and using observations of
the distance and 3D velocities of M31. 
...
\begin{table*}
  ...
  \begin{tabular}{lc|c}
    \hline\hline
    Method & Result & Citation \\\hline
    {LV Galaxies + Timing Argument} & {2.64$\pm0.4\times 10^{12}\msun$} & \cite{Penarrubia2016} \\
    {Timing only} & {4.27$\pm$0.45$\times 10^{12}$\msun} & \cite{vdm2012} \\
    {Timing (3D + cosmic bias and scatter)} & {4.93$\pm$1.63$\times 10^{12}$\msun} & \cite{vdm2012} \\
    Timing (radial + cosmo sim calibration)  & $5.27\times10^{12}$ \msun & \cite{LiWhite2008} \\
    Timing & $3.6\times10^{12}\msun$ & \cite{Lynden-Bell:1981} \\
    $2.5\pm0.4\times10^{12}\msun$ & \cite{Diaz2014}\\
    %  &  &  \\
    \hline
    Kinematics of M31 Sats & \mmto$ <(300 kpc) = (1.40 \pm 0.43) \times 10^{12} \msun$ & \cite{Watkins2010}\\
  \hline\hline
  \end{tabular}
